...
def get_parser():
    ...
    parser.add_argument(
        '--num-worker',
        type=int,
        # default=16, #for windows
        default=4, #for windows
        # default=0,  #for windows
    ...
    def load_data(self):
        ...
        if self.arg.phase == 'train':
            self.data_loader['train'] = torch.utils.data.DataLoader(
                ...
                shuffle=True,
                pin_memory=True,
                # (reduces RAM usage on Windows) from 16 to 2 or 4
                # prefetch_factor=2,
                prefetch_factor=4,
                num_workers=self.arg.num_worker, # Will pass 4 from args in Windows
                drop_last=True,
